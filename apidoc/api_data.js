define({ "api": [
  {
    "type": "post",
    "url": "https://virtualhubukraine.azurewebsites.net/api/api/signin",
  ...
  {
    "type": "post",
    "url": "https://virtualhubukraine.azurewebsites.net/api/api/newPass",
    "title": "New password",
    "name": "newPass",
    "version": "1.0.0",
    "group": "Account",
  ...
  {
    "type": "post",
    "url": "https://virtualhubukraine.azurewebsites.net/api/api/recoverpass",
  ...
  {
    "type": "post",
    "url": "https://virtualhubukraine.azurewebsites.net/api/api/signUp",
    "title": "New account",
    "name": "signUp",
    "version": "1.0.0",
    "group": "Account",
    "description": "<p>This method allows you to create a user account in Rare Diseases Hub Ukraine</p>",
    "examples": [
      {
        "title": "Example usage:",
  ...
  {
    "type": "post",
    "url": "https://virtualhubukraine.azurewebsites.net/api/api/updatepass",
  ...
  {
    "type": "put",
    "url": "https://virtualhubukraine.azurewebsites.net/api/requestclin/status/:requestId",
    "title": "Update Status",
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/group/",
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/groupadmin/",
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/groups/",
    "title": "Get groups",
    "name": "getGroups",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://virtualhubukraine.azurewebsites.net/api/groups)\n .subscribe( (res : any) => {\n   console.log('groups: '+ res.groups);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/groupsnames/",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://virtualhubukraine.azurewebsites.net/api/groupsnames)\n .subscribe( (res : any) => {\n   console.log('groups: '+ res.groups);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/langs/",
    "title": "Get languages",
    "name": "getLangs",
    "description": "<p>This method return the languages available in Rare Diseases Hub Ukraine. you get a list of languages, and for each one you have the name and the code. We currently have 5 languages, but we will include more. The current languages are:</p> <ul> <li>English: en</li> <li>Spanish: es</li> <li>German: de</li> <li>Dutch: nl</li> <li>Portuguese: pt</li> </ul>",
    "group": "Languages",
    "version": "1.0.0",
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://virtualhubukraine.azurewebsites.net/api/langs)\n .subscribe( (res : any) => {\n   console.log('languages: '+ res.listLangs);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/patients/:patientId",
    "title": "Get patient",
    "name": "getPatient",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://virtualhubukraine.azurewebsites.net/api/patients/'+patientId)\n .subscribe( (res : any) => {\n   console.log('patient info: '+ res.patient);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "header": {
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/patients-all/:userId",
  ...
  {
    "type": "put",
    "url": "https://virtualhubukraine.azurewebsites.net/api/patient/status/:patientId",
    "title": "Update Status",
  ...
  {
    "type": "get",
    "url": "https://virtualhubukraine.azurewebsites.net/api/users/:id",
    "title": "Get user",
    "name": "getUser",
    "version": "1.0.0",
    "group": "Users",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://virtualhubukraine.azurewebsites.net/api/users/'+userId)\n .subscribe( (res : any) => {\n   console.log(res.userName);\n}, (err) => {\n  ...\n}",
        "type": "js"
      }
    ],
    "header": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.put('https://virtualhubukraine.azurewebsites.net/api/users/'+userId, this.user)\n .subscribe( (res : any) => {\n   console.log('User update: '+ res.user);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "header": {
